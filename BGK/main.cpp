...
const int nx = 502, ny = nx, np = 9;
const double U_ref = 2., Reynolds = 628., Tmax = 2., Scale_time = 1E-4;
...
const int nsteps = int(Tmax/Scale_time)+1, n_out = int(Tmax/Scale_time)/50;
